...
const OUT = "C:\\Users\\Vivaan\\Desktop\\spartan\\design\\assets\\hero";
...
for (const [pnoStr, name] of Object.entries(NAMES)) {
  ...
  const pix = new mupdf.Pixmap(mupdf.ColorSpace.DeviceRGB, [0, 0, Math.round(PW * S), Math.round((PH - TOP) * S)], false);
  pix.clear(255);
