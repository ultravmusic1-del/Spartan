 ...
 */
{
  ...
  const placeholder = config.includes('spartan.example') || robots.includes('spartan.example');
  if (placeholder) console.log('  note   domain is still the spartan.example placeholder (launch blocker, not a regression)');
}
